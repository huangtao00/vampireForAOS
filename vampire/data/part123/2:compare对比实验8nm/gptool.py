...
class gpt():
	...
	def add_all_curve(self,datas):
		...
		for cid in range(0,curve_number):
			...
			ax.plot(xarray,yarray, linestyle=style,color=color,label=legend,marker=marker,linewidth=1,markersize=8)
...
if __name__=="__main__":
	...
	label=["Temperature$(K)$","Magnetization$(M/M_{s})$"]
	curve={}
	filename="output"
	...
	legend=["Extened Near Model","Nearest Neighbors Model","8nm","10nm"]
	fnlist=["output.ENM","output.NNM"]
	style=["","-"]
