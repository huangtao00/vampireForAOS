...
#macro Bone(sx,sy,sz,endx,endy,endz,r)
union{
...
//#declare sscale0=1.2;   //for Fe and Pt
#declare sscale0=0.8;    //for effective FePt
#declare rscale0=1;
#declare cscale0=1;
#declare cones0=0;
#declare spheres0=1;
...
#macro spinm0(cx,cy,cz,sx,sy,sz, cr,cg,cb)  //for Fe
union{
#if(spheres0) sphere {<cx,cy,cz>,0.3*rscale0 no_shadow} #end
...
#if(arrows0) 
cylinder {
<cx+sx*0.5*sscale0,cy+sy*0.5*sscale0,cz+sz*0.5*sscale0>,
<cx-sx*0.5*sscale0,cy-sy*0.5*sscale0,cz-sz*0.5*sscale0>,
sscale0*0.12 // 0.1 for Fe and Pt
}
cone {
<cx+sx*0.5*1.6*sscale0,cy+sy*0.5*1.6*sscale0,cz+sz*0.5*1.6*sscale0>,
sscale0*0.0 
<cx+sx*0.5*sscale0,cy+sy*0.5*sscale0,cz+sz*0.5*sscale0>,
sscale0*0.2  // 0.16 for Fe and Pt
} 
#end
#if(spincolors0) texture { pigment {color rgb <0.9 0 0>}finish {reflection {ref} diffuse 1 ambient 0}}
...
#macro spinm1(cx,cy,cz,sx,sy,sz, cr,cg,cb)  //for Pt
union{
...
#if(arrows1) 
cylinder {
<cx+sx*0.5*sscale1,cy+sy*0.5*sscale1,cz+sz*0.5*sscale1>,
<cx-sx*0.5*sscale1,cy-sy*0.5*sscale1,cz-sz*0.5*sscale1>,
sscale1*0.12
}
cone {
<cx+sx*0.5*1.6*sscale1,cy+sy*0.5*1.6*sscale1,cz+sz*0.5*1.6*sscale1>,
sscale1*0.0 
<cx+sx*0.5*sscale1,cy+sy*0.5*sscale1,cz+sz*0.5*sscale1>,
sscale1*0.20
} 
#end
#if(spincolors1) texture {pigment {color rgb <1 1 1> }finish {reflection {ref} diffuse 1 ambient 0}}
